...
export function ChatSidebar() {
    ...
    const GetAIResponse = async () => {
        ...
        console.log("result to calc token", result.data.result);

        // CHECKING TOKEN CALCULATION USED
        console.log("USER TOKEN VALUE = ", user_token);
        if (user_token > 0) {
            ...
            console.log("COUNTED AI TEXT RESPONSE TOKENS ARE = ", Number(countToken(JSON.stringify(result.data.result))));
            if (calculated_token) {
            ...
            console.log("Token value is zero or less than zero!!", user_token);
        }
